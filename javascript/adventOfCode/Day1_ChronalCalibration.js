...
const findDuplicate = (searchArr, track = {}) => {
  ...
  // If an object is returned, keep searching
  if (typeof result === 'object') return findDuplicate(searchArr, result)

  // Otherwise, returned number is the duplicate
  return result
}

console.log('Chronal Calibration - Part Two:', findDuplicate(input))
